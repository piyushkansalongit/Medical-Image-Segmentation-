...
pkl_file = open('../pickle_files/Lat_Vertebra.pkl', 'rb')
...
mcp_save = ModelCheckpoint('Lat_Vertebra.hdf5', save_best_only=True, monitor='val_loss', mode='min')
...
for i in range(X_test.shape[0]):
    ...
    plt.savefig(fname = os.path.join("../samples/Lat_Vertebra", str(i)+".png"))
    plt.show()
