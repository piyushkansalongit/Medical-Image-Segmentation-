...
pkl_file = open('../pickle_files/Ap_Spinous_Process.pkl', 'rb')
...
mcp_save = ModelCheckpoint('Ap_Spinous_Process.hdf5', save_best_only=True, monitor='val_loss', mode='min')
...
for i in range(X_test.shape[0]):
    ...
    plt.savefig(fname = os.path.join("../samples/Ap_Spinous_Process", str(i)+".png"))
    plt.show()
