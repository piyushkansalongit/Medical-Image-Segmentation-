...
def parse_args():
    ...
    parser.add_argument('--name', default="Ap_Pedicle",
    ...
    for class_folder in os.listdir(DATA_PATH):
        ...
        for patient_folder in os.listdir(FOLDER_PATH):
            ...
            if os.path.isdir(patient_folder):
                if(os.path.isfile(os.path.join(patient_folder, 'AP/Ap_Pedicle.png'))):
                    mask_paths.append(os.path.join(patient_folder, 'AP/Ap_Pedicle.png'))
