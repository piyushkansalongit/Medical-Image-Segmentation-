...
pkl_file = open('../pickle_files/Lat_Anterior_Vertebral_Line.pkl', 'rb')
...
mcp_save = ModelCheckpoint('Ap_Lat_Anterior_Vertebral_Line.hdf5', save_best_only=True, monitor='val_loss', mode='min')
...
for i in range(X_test.shape[0]):
    ...
    plt.savefig(fname = os.path.join("../samples/Lat_Anterior_Vertebral_Line", str(i)+".png"))
    plt.show()
